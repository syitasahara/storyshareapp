class r{async render(){return`
        ...
        `}async afterRender(){this.loadCSS(),this.setupEventListeners()}loadCSS(){if(!document.querySelector('link[href*="about.css"]')){const e=document.createElement("link");e.rel="stylesheet",e.href="/styles/about.css",document.head.appendChild(e)}}setupEventListeners(){this.setupScrollAnimations(),document.querySelectorAll(".cta-actions .btn").forEach(i=>{i.addEventListener("click",n=>{n.preventDefault();const a=i.getAttribute("href");window.location.hash=a})})}setupScrollAnimations(){const e={threshold:.1,rootMargin:"0px 0px -50px 0px"},i=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&(s.target.style.opacity="1",s.target.style.transform="translateY(0)")})},e);document.querySelectorAll(".value-card, .feature-item, .tech-item").forEach(a=>{a.style.opacity="0",a.style.transform="translateY(20px)",a.style.transition="opacity 0.6s ease, transform 0.6s ease",i.observe(a)})}}export{r as default};
